...
function LandingLink (props) {
  ...
  if (to) {
    return (
      <Link to={to} className='btn-primary btn sm-col-12 block col-12 mb2 center'>
        {text}
      </Link>
    );
  } else if (click) {
    ...
    return (
      <a href="#" onClick={_click}
         className='btn-primary btn sm-col-12 block col-12 mb2 center'>
        {text}
      </a>
    );
  }
...
class Landing extends React.Component {
  ...
  render () {
    return (
        <div className='landing center px3 py4 white bg-gray bg-cover bg-center'>
